...
class My_dogRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # ------------------------------Actions------------------------------ 动作配置
        self.actions.joint_pos.scale = {".*_hip_joint": 0.2, "^(?!.*_hip_joint).*": 0.35}  # 增大步幅：提高关节动作缩放，允许更大的步幅输出
        ...
        self.rewards.flat_orientation_l2.weight = -10.0  # 减少身体晃动：加强姿态倾斜惩罚，保持身体水平
        ...
        self.rewards.action_rate_l2.weight = -0.04  # 增大步幅+降低步频：减轻动作平滑惩罚，允许更大步幅的动作变化
        ...
        self.rewards.feet_air_time.weight = 5.0  # 降低步频：鼓励更长的离地时间
        self.rewards.feet_air_time.params["threshold"] = 0.35  # 降低步频：更易达成的离地时间阈值，避免为达标而踮脚快走
        ...
        self.rewards.feet_height.weight = 3.0  # 防止拖地：加强抬脚奖励权重
        self.rewards.feet_height.params["asset_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_height.params["target_height"] = 0.18  # 防止拖地：提高抬脚目标到0.18m
